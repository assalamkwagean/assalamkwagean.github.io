 ...
 */
function getAppLogo() {
  // Ganti dengan nama file logo Anda di Google Drive
  const LOGO_FILE_NAME = "logo_pondok.png"; // Sesuaikan dengan nama file Anda
  return getDriveImageURL(LOGO_FILE_NAME);
}
