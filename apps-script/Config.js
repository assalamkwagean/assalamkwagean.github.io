/*
  CONFIG.Aplikasi (disalin dari config.js asli)
*/
...
function getPondokName() { return CONFIG.PONDOK_NAME; }
function getPesantrenName() { return CONFIG.PESANTREN_NAME; }
function getAcademicYear() { return CONFIG.ACADEMIC_YEAR; }
function getLogoFileName() { return CONFIG.LOGO_FILE_NAME; }
function getFullInstitutionName() { return CONFIG.PONDOK_NAME + ' ' + CONFIG.PESANTREN_NAME; }
